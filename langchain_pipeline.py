...
def handle_data(elements, cycle):
    return (group_elements(randomize_elements(elements)), cycle + 1
...
def run_shell_command(cmd: str, max_attempts: int = 5, timer_duration: int = 0):
