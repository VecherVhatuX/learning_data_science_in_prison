...
def create_dataset(samples, labels, batch_size, num_negatives):
    ...
    return CustomDataset(samples, labels, batch_size, num_negatives)

def create_model(num_embeddings, embedding_dim, num_negatives):
    ...
    return TripletModel(num_embeddings, embedding_dim, num_negatives)
...
def main():
    ...
    model = create_model(101, 10, num_negatives)
