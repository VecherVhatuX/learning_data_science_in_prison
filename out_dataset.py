...
class TripletCreator:
    def __init__(self, num_negatives_per_positive):
...
class BugTripletModelRunner:
    def __init__(self, max_sequence_length, embedding_size, fully_connected_size, dropout_rate, learning_rate_value, epochs, batch_size, num_negatives_per_positive):
        self.max_sequence_length = max_sequence_length
