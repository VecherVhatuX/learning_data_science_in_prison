...
class TripletDataset(Dataset):
    def __init__(self, dataset_path, snippet_folder_path):
        ...
        self.folder_paths = self.get_subfolder_paths(snippet_folder_path)
    ...
    def __getitem__(self, index):
        ...
        return self.encode_triplet(self.triplets[folder_index][triplet_index], self.tokenizer, MAX_LENGTH)
    ...
    def encode_triplet(self, triplet, tokenizer, max_length):
        encoded_triplet = {}
